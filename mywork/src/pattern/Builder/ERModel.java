...
public class ERModel {
	...
	public void showStructure() {
		...
		for (Enumeration elem = modelRelations.elements(); elem.hasMoreElements();) {
			Relationship currRel = (Relationship) elem.nextElement();
			System.out.println("[ " + currRel.entity1.name + " ]--(" + currRel.cardMin1 + "," + currRel.cardMax1
					+ ")------< " + currRel.name + " >------(" + currRel.cardMin2 + "," + currRel.cardMax2 + ")--[ "
